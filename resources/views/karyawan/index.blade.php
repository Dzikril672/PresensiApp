                    ...
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            <span class="input-icon-addon">
                                ...
                                <input type="text" value="" class="form-control" placeholder="NIK" name="nik" id="nik">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            <span class="input-icon-addon">
                                ...
                                <input type="text" value="" class="form-control" placeholder="Nama Lengkap" name="nama_lengkap" id="nama_lengkap">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            <span class="input-icon-addon">
                                ...
                                <input type="text" value="" class="form-control" placeholder="Jabatan" name="jabatan" id="jabatan">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            <span class="input-icon-addon">
                                ...
                                <input type="text" value="" class="form-control" placeholder="No. Handphone" name="no_hp" id="no_hp">
                        </div>
                    </div>
                </div>
